...
// Added FaEnvelope and FaPaperPlane to imports
import { FaBagShopping, FaRegUser, FaGear, FaTable, FaBars, FaEnvelope, FaPaperPlane } from "react-icons/fa6";
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto">
          ...
          {/* --- NEW TABS ADDED HERE --- */}
          <SidebarLink href="/dashboard/admin/messages" icon={<FaEnvelope />}>Messages</SidebarLink>
          <SidebarLink href="/dashboard/admin/newsletter" icon={<FaPaperPlane />}>Newsletter</SidebarLink>
