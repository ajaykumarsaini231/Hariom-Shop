console.log("🌱 Seeding products...");
  ...
  const laptopImages = ["laptop.png", "macbook.jpg", "macbook2.jpg", "laptopscreen.jpg", "acer_nitro_5_laptop_lcd_screen.jpg", // Using screen images as proxies for models if needed
